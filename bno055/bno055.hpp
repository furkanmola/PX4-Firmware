...
extern device::Device *BNO055_I2C_interface(int bus, int bus_frequency);

class BNO055 : public I2CSPIDriver<BNO055>
{
public:
  BNO055(device::Device *interface, enum Rotation rotation, I2CSPIBusOption bus_option, int bus);
  virtual ~BNO055();
